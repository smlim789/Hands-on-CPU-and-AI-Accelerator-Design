...
module my_cpu_sol (reset, clk, addr, data, memrq, rnw);
	input reset, clk;
	inout [15:0] data;
	output [11:0] addr;
	output memrq, rnw;
...
module mem (clk, addr, data, memrq, rnw); 
	...
	initial begin
		mem[0] = {`LDA, 12'h66}; // answer
		mem[1] = {`SUB, 12'h65}; // answer
		mem[2] = {`STO, 12'h66}; // answer
		mem[3] = {`LDA, 12'h66}; // answer
		mem[4] = {`SUB, 12'h64}; // answer
		mem[5] = {`STO, 12'h66}; // answer
		mem[6] = {`STP, 12'h0};
		mem['h64] = 16'h0011;
		mem['h65] = 16'h0222;
		mem['h66] = 16'h3333;
